...
export const PlacePage = () => {
      ...
      <div className="absolute inset-0 bg-black text-white min-h-screen">
        <div className="p-8 grid gap-4 bg-black">
          <div>
            ...
            <button onClick={()=>{setShowAllPhotos(false)}} className="fixed flex right-12 top-8 gap-1 py-2 px-4 rounded-2xl shadow shadow-black bg-white text-black">
  ...
  return (
    <div className="mt-4 bg-gray-100 -mx-12 px-12 pt-8">
      ...
      <div className="">
        <div className="grid relative gap-2 grid-cols-[2fr_1fr] rounded-3xl overflow-hidden">
          <div>
            {place.photos?.[0] && (
              <div>
                <img
